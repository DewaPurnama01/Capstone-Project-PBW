        ...
        <div class="card" style="padding:0;overflow:hidden;">
            <div id="menuGrid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(150px,1fr));gap:1px;background:#f0ede0;">
                ...
                <div class="menu-item"
                     ...
                     style="background:#fff;padding:14px;cursor:pointer;transition:background 0.15s;user-select:none;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\cns-laravel-v2\cns-fixed\resources\views/transaksi/create.blade.php ENDPATH**/ ?>