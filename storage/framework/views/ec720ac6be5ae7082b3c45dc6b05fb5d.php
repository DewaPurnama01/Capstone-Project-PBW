...
<div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
    ...
    <div style="margin-left:auto;display:flex;gap:10px;align-items:center;">
        ...
        <a href="<?php echo e(route('transaksi.edit', $transaksi->id)); ?>" class="btn-secondary" style="font-size:13px;text-decoration:none;">✎ Edit</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hindi\OneDrive\Desktop\TUGAS AKHIR\cns\cns-laravel-v2\cns-fixed\resources\views/transaksi/show.blade.php ENDPATH**/ ?>