                ...
                <tr class="table-row" style="border-bottom:1px solid #f0ede0;">
                    ...
                    <td style="padding:13px 16px;text-align:center;">
                        <div style="display:flex;gap:6px;justify-content:center;flex-wrap:wrap;">
                            ...
                            <form method="POST" action="<?php echo e(route('transaksi.destroy', $t->id)); ?>" style="margin:0;" onsubmit="return confirm('Hapus transaksi ini?');">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hindi\OneDrive\Desktop\TUGAS AKHIR\cns\cns-laravel-v2\cns-fixed\resources\views/transaksi/index.blade.php ENDPATH**/ ?>