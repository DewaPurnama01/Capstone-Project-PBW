...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Cafe CNS</title>
...
<div class="app-layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <?php $__currentLoopData = $navGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="sidebar-nav-label"><?php echo e($groupName); ?></div>
                <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(in_array($role, $item['roles'])): ?>
                        <?php $isActive = request()->is($item['path'].'*'); ?>
                        <a href="/<?php echo e($item['path']); ?>" class="nav-link <?php echo e($isActive ? 'active' : ''); ?>">
                            <span style="font-size:14px;width:18px;text-align:center;"><?php echo e($item['icon']); ?></span>
        ...
        <div class="sidebar-user">
            <div class="sidebar-user-info">
                <div class="sidebar-avatar"><?php echo e($user['avatar'] ?? '??'); ?></div>
                <div style="flex:1;min-width:0;">
                    <p style="color:#fff;font-size:12px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($user['name'] ?? 'User'); ?></p>
                    <p style="color:rgba(255,255,255,0.38);font-size:10px;"><?php echo e($user['role'] ?? ''); ?></p>
                </div>
            </div>
    ...
    <main class="main-content">
        ...
        <?php $__currentLoopData = ['success','error','warning','info']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(session($type)): ?>
            <div class="alert-<?php echo e($type); ?> mx-6 mt-4 flex items-center gap-2" style="font-size:14px;">
                <span><?php echo e(['success'=>'✓','error'=>'✕','warning'=>'⚠','info'=>'ℹ'][$type]); ?></span>
...
<?php /**PATH C:\Users\hindi\OneDrive\Desktop\TUGAS AKHIR\cns\cns-laravel-v2\cns-fixed\resources\views/layouts/app.blade.php ENDPATH**/ ?>