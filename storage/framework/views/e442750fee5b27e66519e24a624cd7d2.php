    ...
    <div class="hidden lg:flex flex-col justify-between p-12" style="width: 420px; background: linear-gradient(160deg, #0c4a0d 0%, #1a6b1c 55%, #246b24 100%); flex-shrink: 0;">
        ...
        <div>
            ...
            <div class="mt-8 space-y-4">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon, $role, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-start gap-3">
                    <span class="text-xl mt-0.5"><?php echo e($icon); ?></span>
                    <div>
                        <p style="color:#fff;font-weight:600;font-size:0.85rem;"><?php echo e($role); ?></p>
                        <p style="color:rgba(255,255,255,0.5);font-size:0.75rem;line-height:1.5;"><?php echo e($desc); ?></p>
                    </div>
                </div>
        ...
        <div style="width: 100%; max-width: 440px;">
            ...
            <div style="background:#ffe4e4;color:#d4183d;border:1px solid #f5c0c0;border-radius:10px;padding:12px 16px;" class="mb-4">
                ...
                <ul class="list-disc list-inside space-y-1">
                    ...
                    <li style="font-size:0.82rem;"><?php echo e($error); ?></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <?php endif; ?>
            ...
            <form method="POST" action="/register" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name')); ?>"
                           style="width:100%;border:1px solid <?php echo e($errors->has('name') ? '#d4183d' : '#E7E1B1'); ?>;background:#FBF5DD;border-radius:10px;padding:10px 14px;font-size:0.9rem;outline:none;box-sizing:border-box;"
                ...
                <div>
                    ...
                    <input type="text" name="username" value="<?php echo e(old('username')); ?>"
                           style="width:100%;border:1px solid <?php echo e($errors->has('username') ? '#d4183d' : '#E7E1B1'); ?>;background:#FBF5DD;border-radius:10px;padding:10px 14px;font-size:0.9rem;outline:none;box-sizing:border-box;"
                ...
                <div>
                    ...
                    <select name="role"
                            style="width:100%;border:1px solid <?php echo e($errors->has('role') ? '#d4183d' : '#E7E1B1'); ?>;background:#FBF5DD;border-radius:10px;padding:10px 14px;font-size:0.9rem;outline:none;box-sizing:border-box;" required>
                        <option value="">-- Pilih Role --</option>
                        <option value="Owner"  <?php echo e(old('role') === 'Owner'  ? 'selected' : ''); ?>>👑 Owner (Manajer Operasional)</option>
                        <option value="Admin"  <?php echo e(old('role') === 'Admin'  ? 'selected' : ''); ?>>⚙️ Admin (Inventori & Kemitraan)</option>
                        <option value="Kasir"  <?php echo e(old('role') === 'Kasir'  ? 'selected' : ''); ?>>🧾 Kasir (Transaksi & Pelanggan)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="password" name="password"
                           style="width:100%;border:1px solid <?php echo e($errors->has('password') ? '#d4183d' : '#E7E1B1'); ?>;background:#FBF5DD;border-radius:10px;padding:10px 14px;font-size:0.9rem;outline:none;box-sizing:border-box;"
...
<?php /**PATH C:\cns-laravel-v2\cns-fixed\resources\views/auth/register.blade.php ENDPATH**/ ?>