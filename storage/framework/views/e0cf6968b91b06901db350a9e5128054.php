...
<head>
    ...
    <title>Laporan Cafe CNS — <?php echo e(now()->format('d M Y')); ?></title>
    <style>
...
<div class="header">
    ...
    <span class="periode">
        Periode: <?php echo e(\Carbon\Carbon::parse($dari)->format('d M Y')); ?> — <?php echo e(\Carbon\Carbon::parse($sampai)->format('d M Y')); ?>

    </span>
    <p style="font-size:10px;color:#888;margin-top:6px;">Dicetak: <?php echo e(now()->format('d M Y, H:i')); ?></p>
</div>
...
<div class="section">
    ...
    <div class="kpi-grid">
        <div class="kpi-box">
            ...
            <div class="value" style="font-size:13px;">Rp <?php echo e(number_format($ringkasan['total_pendapatan'],0,',','.')); ?></div>
        </div>
        <div class="kpi-box">
            <div class="label">Total Transaksi</div>
            <div class="value"><?php echo e(number_format($ringkasan['total_transaksi'])); ?></div>
        </div>
        <div class="kpi-box">
            <div class="label">Rata-rata / Hari</div>
            <div class="value" style="font-size:13px;">Rp <?php echo e(number_format($ringkasan['rata2_per_hari'],0,',','.')); ?></div>
        </div>
        <div class="kpi-box">
            <div class="label">Hutang Belum Bayar</div>
            <div class="value" style="color:#d4183d;font-size:13px;">Rp <?php echo e(number_format($debtReport['belum_bayar'],0,',','.')); ?></div>
        </div>
    </div>
</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-weight:600;"><?php echo e($p->nama_menu); ?></td>
                <td style="text-align:right;"><?php echo e(number_format($p->total_terjual)); ?>×</td>
                <td style="text-align:right;font-weight:600;color:#0D530E;">Rp <?php echo e(number_format($p->total_revenue,0,',','.')); ?></td>
            </tr>
...
<div class="section">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td style="font-weight:600;"><?php echo e($m->metode_bayar); ?></td>
                <td style="text-align:right;"><?php echo e(number_format($m->jumlah)); ?></td>
                <td style="text-align:right;color:#0D530E;font-weight:600;">Rp <?php echo e(number_format($m->total,0,',','.')); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<div class="section">
    ...
    <div class="debt-summary" style="margin-bottom:12px;">
        <div class="debt-box">
            ...
            <div class="value" style="color:#d4183d;">Rp <?php echo e(number_format($debtReport['belum_bayar'],0,',','.')); ?></div>
        </div>
        <div class="debt-box">
            <div class="label">Sudah Dibayar</div>
            <div class="value" style="color:#0D530E;">Rp <?php echo e(number_format($debtReport['sudah_bayar'],0,',','.')); ?></div>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td style="font-weight:600;"><?php echo e($h->nama_mitra); ?></td>
                <td style="text-align:right;font-weight:600;">Rp <?php echo e(number_format($h->jumlah_tagihan,0,',','.')); ?></td>
                <td><?php echo e(\Carbon\Carbon::parse($h->tanggal_jatuh_tempo)->format('d M Y')); ?></td>
                <td>
...
<div class="section">
    ...
    <table>
        ...
        <tbody>
            ...
            <?php $totalPo = (int)($s->total_po ?? 0); $lolosQc = (int)($s->lolos_qc ?? 0); ?>
            <tr>
                <td style="font-weight:600;"><?php echo e($s->nama_mitra); ?></td>
                <td style="text-align:right;"><?php echo e($totalPo); ?></td>
                <td style="text-align:right;color:#0D530E;">Rp <?php echo e(number_format($s->total_nilai ?? 0,0,',','.')); ?></td>
                <td style="text-align:right;"><?php echo e($lolosQc); ?>/<?php echo e($totalPo); ?></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tbody>
    </table>
...
<div class="footer">
    Laporan ini digenerate otomatis oleh Sistem Informasi Manajemen Cafe CNS • <?php echo e(now()->format('d M Y H:i')); ?>
...
<?php /**PATH C:\cns-laravel-v2\cns-fixed\resources\views/laporan/print.blade.php ENDPATH**/ ?>